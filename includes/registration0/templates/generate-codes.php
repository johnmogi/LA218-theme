...
<div class="registration-codes-generate">
    ...
    <div class="card">
        ...
        <!-- Add tabs for different code generation types -->
        <nav class="nav-tab-wrapper">
            <a href="#" class="nav-tab nav-tab-active" data-tab="class-codes">קודים לכיתה</a>
            <a href="#" class="nav-tab" data-tab="individual-codes">קוד לתלמיד בודד</a>
        </nav>
        
        <!-- Class Codes Form -->
        <div id="class-codes-tab" class="tab-content active">
            <form id="generate-class-codes-form" method="post" action="">
                <?php wp_nonce_field('registration_codes_action', 'registration_codes_nonce'); ?>
                <input type="hidden" name="code_type" value="class">
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <!-- Student information fields have been removed from class/bulk form as requested -->
        ...
        <!-- Individual Student Code Form -->
        <div id="individual-codes-tab" class="tab-content" style="display: none;">
            <form id="generate-individual-code-form" method="post" action="">
                <?php wp_nonce_field('registration_codes_action', 'registration_codes_nonce'); ?>
                <input type="hidden" name="code_type" value="individual">
                <input type="hidden" name="code_count" value="1">
                
                <table class="form-table">
                    <tbody>
                        <tr>
                            <th scope="row">
                                <label for="ind-code-role">תפקיד משתמש</label>
                            </th>
                            <td>
                                <select id="ind-code-role" name="code_role" class="regular-text" required>
                                    <?php foreach ($roles as $role => $name) : ?>
                                        <option value="<?php echo esc_attr($role); ?>">
                                            <?php echo esc_html($name); ?>
                                        </option>
                        ...
                        <tr>
                            <th scope="row">
                                <label for="ind-first-name"><?php _e('First Name', 'registration-codes'); ?> (<?php _e('שם פרטי', 'registration-codes'); ?>)</label>
                            </th>
                            <td>
                                <input type="text" 
                                       id="ind-first-name" 
                        ...
                        <tr>
                            <th scope="row">
                                <label for="ind-last-name"><?php _e('Last Name', 'registration-codes'); ?> (<?php _e('שם משפחה', 'registration-codes'); ?>)</label>
                            </th>
                            <td>
                                <input type="text" 
                                       id="ind-last-name" 
                        ...
                        <tr>
                            <th scope="row">
                                <label for="ind-school-name"><?php _e('School Name', 'registration-codes'); ?> (<?php _e('שם בית ספר', 'registration-codes'); ?>)</label>
                            </th>
                            <td>
                                <input type="text" 
                                       id="ind-school-name" 
                        ...
                        <tr>
                            <th scope="row">
                                <label for="ind-school-city"><?php _e('School City', 'registration-codes'); ?> (<?php _e('עיר בית ספר', 'registration-codes'); ?>)</label>
                            </th>
                            <td>
                                <input type="text" 
                                       id="ind-school-city" 
                        ...
                        <tr>
                            <th scope="row">
                                <label for="ind-school-code"><?php _e('School Code', 'registration-codes'); ?> (<?php _e('קוד בית ספר', 'registration-codes'); ?>)</label>
                            </th>
                            <td>
                                <input type="text" 
                                       id="ind-school-code" 
                        ...
                        <tr>
                            <th scope="row">
                                <label for="ind-mobile-phone"><?php _e('Mobile Phone', 'registration-codes'); ?> (<?php _e('טלפון נייד', 'registration-codes'); ?>)</label>
                            </th>
                            <td>
                                <input type="tel" 
                                       id="ind-mobile-phone" 
                        ...
                        <tr>
                            <th scope="row">
                                <label for="ind-user-password"><?php _e('Password', 'registration-codes'); ?> (<?php _e('סיסמה', 'registration-codes'); ?>)</label>
                            </th>
                            <td>
                                <input type="text" 
                                       id="ind-user-password" 
                                       name="user_password" 
                                       class="regular-text" 
                        ...
                        <tr>
                            <th scope="row">
                                <label for="ind-code-course"><?php _e('LearnDash Course', 'registration-codes'); ?></label>
                            </th>
                            <td>
                                <select id="ind-code-course" name="code_course" class="regular-text">
                                    <option value="">-- ללא --</option>
                                    <?php foreach ($courses as $course_id => $course_name) : ?>
                                        <option value="<?php echo esc_attr($course_id); ?>">
                                            <?php echo esc_html($course_name); ?>
                                ...
                                <p class="description">
                                    אופציונלי: בחר קורס LearnDash לרישום המשתמש כאשר הוא משתמש בקוד זה.
                                </p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th scope="row">
                                <label for="ind-code-expiry">תאריך תפוגה</label>
                            </th>
                            <td>
                                <input type="date" 
                                       id="ind-code-expiry" 
                                       ...
                                       class="regular-text">
                                <p class="description">
                                    אופציונלי: הגדר תאריך תפוגה לקוד זה (השאר ריק ללא הגבלת זמן).
                                </p>
                            </td>
                        </tr>
                    </tbody>
