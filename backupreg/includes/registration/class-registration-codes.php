...
class Registration_Codes {
    ...
    public function add_code($code, $role = 'subscriber', $group_name = '', $course_id = null, $max_uses = 1, $expiry_date = null, $user_id = 0, $student_data = array()) {
        ...
        $data = array(
            ...
            'school_city' => $student_data['school_city'],
            'school_code' => $student_data['school_code'],
            'mobile_phone' => $student_data['mobile_phone'],
            'user_password' => $student_data['user_password']
        );
    ...
    public function ajax_generate_codes() {
        ...
        try {
            // Verify nonce
            if (!check_ajax_referer('registration_codes_nonce', 'nonce', false)) {
